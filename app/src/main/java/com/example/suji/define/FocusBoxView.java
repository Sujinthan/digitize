...
public class FocusBoxView extends View {
    ...
    private final int maskColor, frameColor, cornerColor;
    private float myLastTouchX, myLastTouchY, mPosX, mPosY;
    ...
    private  Rect getBoxRect() {
        ...
        if (box == null) {
            ...
            int width = ScrRes.x/2;
            int height = ScrRes.y/2;
            ...
            box = new Rect(left , top ,  width + left/2,  height + top/2);
        }
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    switch (event.getAction()) {
                        ...
                        case MotionEvent.ACTION_MOVE:
                            ...
                            final float dx = x2 - myLastTouchX;
                            final float dy = y2 - myLastTouchX;
